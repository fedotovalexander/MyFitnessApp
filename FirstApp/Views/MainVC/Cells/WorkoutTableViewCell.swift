...
//  FirstApp
//
//  Created by Alexander Fedotov on 16.01.2022.
//
...
class WorkoutTableViewCell: UITableViewCell {
    ...
    private func setupViews() {
        ...
        contentView.addSubview(workoutBackgroundView)
        workoutBackgroundView.addSubview(workoutImageView)
        backgroundCell.addSubview(workoutNameLabel)
       
        labelsStackView = UIStackView(arrangedSubviews: [workoutSetsLabel,workoutRepsLabel],
                                      axis: .horizontal,
                                      spacing: 10)
        backgroundCell.addSubview(labelsStackView)
        backgroundCell.addSubview(startButton)
    }
