...
//  FirstApp
//
//  Created by Alexander Fedotov on 16.02.2022.
//
...
class OnboardingCollectionViewCell: UICollectionViewCell {
    ...
    private let bottomLabel: UILabel = {
        let label = UILabel()
        //label.text = "Bad body shape, poor sleep, lake of strength, weight gain, weak bones, depressed, stressed, poor metabolism, poor resistence"
