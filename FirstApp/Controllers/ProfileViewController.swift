...
class ProfileViewController: UIViewController {
    ...
    private let workoutNowLabel: UILabel = {
        let label = UILabel()
        label.text = "0"
    ...
    private let workoutTargetsLabel: UILabel = {
        let label = UILabel()
        label.text = "0"
        label.font = .robotoBold24()
        label.textColor = .specialGray
    ...
    private let progressView: UIProgressView = {
        ...
        progressView.progressTintColor = .specialBrown
    ...
    private func setupViews() {
        ...
        userParametersStackView = UIStackView(arrangedSubviews: [userHeightLabel, userWeightLabel],
                                         axis: .horizontal,
                                         spacing: 10)
        ...
        targetStackView = UIStackView(arrangedSubviews: [workoutNowLabel, workoutTargetsLabel],
                                         axis: .horizontal,
                                         spacing: 10)
    ...
    func setupUserParameters() {
        if userArray.count != 0 {
            ...
            workoutTargetsLabel.text = "\(userArray[0].userTarget)"
...
extension ProfileViewController {
    private func setConstraints() {
        ...
        NSLayoutConstraint.activate([
            userParametersStackView.topAnchor.constraint(equalTo: userPhotoView.bottomAnchor, constant: 5),
